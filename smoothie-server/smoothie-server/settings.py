"""
Django settings for smoothie-server project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'cedarstats.ca']
...
ROOT_URLCONF = 'smoothie-server.urls'
...
WSGI_APPLICATION = 'smoothie-server.wsgi.application'
